...
namespace review_apis.Migrations
{
    ...
    [Migration("20210417011837_AllTableAddeddd")]
    partial class AllTableAddeddd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("review_apis.Models.FollowModel", b =>
                {
                    ...
                    b.Property<int?>("FollowerUserIdId")
                        .HasColumnType("int");

                    b.Property<int?>("FollowingUserIdId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("FollowerUserIdId");

                    b.HasIndex("FollowingUserIdId");
            ...
            modelBuilder.Entity("review_apis.Models.FollowModel", b =>
                {
                    b.HasOne("review_apis.Models.UserModel", "FollowerUserId")
                        .WithMany()
                        .HasForeignKey("FollowerUserIdId");

                    b.HasOne("review_apis.Models.UserModel", "FollowingUserId")
                        .WithMany()
                        .HasForeignKey("FollowingUserIdId");

                    b.Navigation("FollowerUserId");

                    b.Navigation("FollowingUserId");
                });
